...
- Incoming faculty at the University of Oregon.
- Before that: Finishing up a postdoc at UCSB under Chris Costello.
...
- [GEE live session](https://code.earthengine.google.com/6267d5e6ae8435a9db3b9b1058089f7c).
...
- More work still to be done, but suggests that announcement and enforcement gap should be closed.
  - Granularity of the data should allow us to test different causal hypotheses (e.g. spatial knowledge).
